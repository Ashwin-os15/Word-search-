...
export const CORE_FRIENDS = [
  ...
  "BHARATH","CHARAN","DEEPAK","DINESH","GANESH","GIRISH","GOPAL","HARI",
  "HARISH","HEMANTH","JAYESH","KARTHIK","KISHORE","KRISHNA","KUMAR","LOKESH",
  "MAHESH","MANOJ","MITESH","MOHAN","NAVEEN","NIKHIL","NILESH","NISHANT",
  "PAVAN","PRANAV","PRASHANT","PRAVEEN","RAHUL","RAJESH","RAKESH","RAMESH",
  "RAVI","ROHIT","SACHIN","SANJAY","SANTOSH","SATISH","SHIVA","SHREYAS",
  "SURESH","VARUN","VIKRAM","VINAY","VISHNU","VIVEK","YOGESH","YUVAN",
  "ANANYA","BHAVANA","DEEPIKA","DIVYA","GAYATHRI","HARINI","ISHWARYA",
  "KAVITHA","KEERTHI","LAKSHMI","LAVANYA","MEENA","NITHYA","POOJA",
  "PREETHI","PRIYA","RACHANA","REVATHI","SANDHYA","SARANYA","SHRUTI",
  "SNEHA","SOWMYA","SRIDEVI","SRUTHI","SUDHA","SWATHI","TRISHA","VAISHNAVI",
];

const FILLER_SI = [
  "AMRITA","CHAITRA","DHANUSH","GEETHA","INDU","JAYA","KAMALA","KIRAN",
  "MALA","NALINI","PADMA","RADHA","RANJITHA","RENU","SHANTI","USHA",
];
